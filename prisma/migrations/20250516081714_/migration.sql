...
-- DropForeignKey
ALTER TABLE "activity_logs" DROP CONSTRAINT "activity_logs_team_id_fkey";
...
-- AddForeignKey
ALTER TABLE "Invitation" ADD CONSTRAINT "Invitation_email_fkey" FOREIGN KEY ("email") REFERENCES "users"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
