...
-- CreateIndex
CREATE UNIQUE INDEX "teams_steppay_customer_id_key" ON "teams"("steppay_customer_id");

-- CreateIndex
CREATE UNIQUE INDEX "teams_steppay_subscription_id_key" ON "teams"("steppay_subscription_id");
